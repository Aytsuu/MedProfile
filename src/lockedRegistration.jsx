...
function Registration() {
    ...
    const [inputsLocked, setInputsLocked] = useState(true);  // disables the input fields
            ...
            <div className="relative h-3/4 w-4/6 border-2 rounded-lg top-16 bg-white shadow-lg drop-shadow-md p-8">
                ...
                <form method="POST" onSubmit={handleSubmit} className="flex flex-col">
                    ...
                    <div className="flex flex-row mt-16">
                        ...
                        <button type="submit"
                            className="flex h-10 w-10 m-2 bg-orange-400 rounded-md items-center justify-center
                                hover:bg-orange-200">
                            <div className="flex items-center space-x-3">
                                <MdOutlineSync  size="30" />
                            </div>
                        </button>
                        <div className="ml-auto flex h-10 w-10 m-2 justify-center items-center rounded-md hover:bg-slate-200 hover:rounded-lg hover:border-2">
