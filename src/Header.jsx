            ...
            {isLogout && (
                <div className="flex items-center w-screen h-[7rem] bg-none justify-between absolute">
                    ...
                    <div className = "flex flex-col items-end mr-[4rem] h-full">
                        {/*--------------------------------Profile Header--------------------------*/}
                            <div onClick = {toggleDropdown} className="flex items-center space-x-4 p-2 mr-[30px] cursor-pointer mt-3">
                                {/*Profile Image*/}
                                <div className="w-[40px] h-[40px] bg-blue-500 rounded-full border border-white"></div>
                                {/*Profile username*/}
                                <p className = "font-outfit text-[17px] text-teal-900">ironheartmcu</p>
                                {/*Dropdown Icon*/}
                            </div>
                        ...
                        {/*--------------------------------Dropdown Menu-------------------------------------*/}
                            <div className = "relative">
                                {isDropdownOpen && (
                                <ul role="menu" className="absolute right-[-20px] mt-2 w-[240px] bg-white rounded-3xl drop-shadow-lg border flex flex-col items-center py-4 space-y-2">
                                    {/*Dropdown Menu*/}
                            ...
                            {isManageAccount && (
                                <div className = "fixed right-0 top-0 w-[439px] h-full bg-white drop-shadow-lg border rounded-tl-[30px] rounded-bl-[30px] z-50">
                                    <div className = "flex items-center space-x-[110px] pl-3 pr-3">
                                        <img className="w-[30px] h-[73px] cursor-pointer" onClick={ () => {PasswordandUsernameUI();setisChangePassword(false); setisChangeUsername(false);setisManageAccount(false);}}></img>
                                        ...
                                        <div className = "w-[325px] h-[300px] bg-custom-teal rounded-[20px] mt-[10px] drop-shadow-lg flex flex-col items-center">
                                            ...
                                            <div className="w-[100px] h-[100px] bg-blue-500 rounded-full mt-[10px] border border-white flex items-end">
                                                <div className="w-[27px] h-[27px] bg-white border rounded-full ml-[65px]">
                                                    <img className= "ml-[4px] mt-[3px]"></img>
                                                </div>
                                            </div>
                                            ...
                                            {isChangeUsername &&(
                                                        <div className="w-[325px] h-[250px] bg-white border drop-shadow-lg rounded-[20px] mt-[30px] flex flex-col items-center">
                                                            ...
                                                            <div className="flex items-center justify-end space-x-3 35px] mt-[35px] w-full mr-[40px]">
                                                                <button className={backbutton} onClick={() => {PasswordandUsernameUI(); setisChangeUsername(false);}}></button>
                                            ...
                                            {isChangePassword && (
                                                    <div className = "w-[325px] h-[300px] bg-white border drop-shadow-lg rounded-[20px] mt-[20px] flex flex-col items-center">
                                                        ...
                                                        <div className="flex items-center justify-end space-x-3 35px] mt-[35px] w-full mr-[40px]">
                                                            <button className={backbutton} onClick={() => {PasswordandUsernameUI();setisChangePassword(false);}}></button>
                                                            <button className={savebutton}>Save</button>
                                                        </div>
                    ...
                    {isArchive && (
                        <div className=" fixed w-[659px] h-full border bg-white drop-shadow-lg rounded-l-[20px] right-0 top-0">
                            <div className = "flex items-center space-x-[270px] pl-3 pr-3">
                                <img className="w-[30px] h-[73px] cursor-pointer" onClick = {() => {setisArchive(false)}}></img>
                                <p className = "text-[18px] font-medium text-teal-900 font-outfit">Archive</p>
                            </div>

                            <div className="flex flex-col">
                                <button className={archiveList}>TODAY</button>
                                <button className={archiveList}>THIS WEEK</button>
                                <button className={archiveList}>THIS MONTH</button>
                                <button className={archiveList}>THIS YEAR</button>
                            </div>
                        </div>
                    )}
                        ...
                        <div className = "flex items-center justify-center mt-[225px]">
                            <div className = "w-[377px] h-[359px] border bg-white rounded-[20px] drop-shadow-lg">
                                <div className="flex items-start space-x-[25px] p-5 ">
                                    <p className="font-outfit text-teal-900 font-medium text-[15px] p-[5px]">SIGNOUT CONFIRMATION</p>
                                </div>
