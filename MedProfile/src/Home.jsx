...
export default function Home() {
  ...
  const buttonStyles = {
    button:`absolute bottom-10 flex items-center gap-1 rounded-md bg-white py-2 px-4 border border-transparent text-center text-md text-[#033e44] transition-all shadow-md hover:shadow-lg focus:shadow-none active:bg-slate-700 hover:bg-slate-100 active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none ml-2" type="button`,
  }

  const Home = (
    <div className="font-outfit flex gap-[2.5vw] max-[500px]:flex-col my-auto bg-white h-screen w-screen items-center justify-center px-32">
